      ...
      {requests.map((r) => {
        ...
        return (
          <div
            ...
            style={{
              background: r.is_read ? 'rgba(255,255,255,0.02)' : 'rgba(200,151,58,0.04)',
              borderColor: r.is_read ? 'rgba(200,151,58,0.08)' : 'rgba(200,151,58,0.16)',
            }}
          >
            {/* Header row */}
            <button
            ...
            >
              ...
              {meta && (
                <div className="hidden sm:flex gap-2 flex-shrink-0">
                  {meta.type && (
                    <span className="text-xs px-2 py-0.5 rounded-full bg-white/5 text-brand-gold/60 capitalize">
                      {meta.type}
                    </span>
                  )}
                  {meta.budget && (
            ...
            {isOpen && (
              ...
              >
                  ...
                  {meta &&
                    Object.entries(meta).map(([k, v]) =>
                      v ? (
                        ...
                        >
                          <p className="text-brand-gold/40 mb-1 capitalize">
                            {k.replace(/_/g, ' ')}
                          </p>
                ...
                <a
                  href={`mailto:${r.email}?subject=Re: Custom Order Request`}
