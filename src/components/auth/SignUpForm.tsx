    ...
    <div className="w-full max-w-md">
      <div className="card p-8">
        ...
        <p className="text-sm text-brand-text-secondary mb-6">
          Join us for orders, custom cakes, and more
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="fullName" className="block text-xs text-brand-text-secondary mb-1.5">
              Full name
            </label>
            <input
              id="fullName"
          ...
          <p className="text-xs text-brand-text-secondary text-center">
            ...
            <Link href="/legal/terms" className="text-brand-gold hover:underline">
              Terms
            </Link>{' '}
            and{' '}
            <Link href="/legal/privacy" className="text-brand-gold hover:underline">
              Privacy Policy
            </Link>
            .
          </p>
