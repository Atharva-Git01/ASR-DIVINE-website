      ...
      >
        <table className="w-full text-sm">
          <thead>
            <tr
              className="border-b"
              style={{ background: 'rgba(200,151,58,0.06)', borderColor: 'rgba(200,151,58,0.10)' }}
            >
          ...
          <tbody className="divide-y" style={{ borderColor: 'rgba(200,151,58,0.06)' }}>
            {orders.length === 0 && (
              <tr>
                <td colSpan={6} className="px-4 py-8 text-center text-sm text-brand-gold/40">
                  No orders found.
                </td>
              </tr>
            )}
                ...
                <tr key={o.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span
                      ...
                      style={{
                        background: `${STATUS_COLOR[o.status] ?? '#8B5E3C'}18`,
                        color: STATUS_COLOR[o.status] ?? '#8B5E3C',
                      }}
                    >
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={`text-xs ${o.payment_status === 'paid' ? 'text-green-400' : 'text-brand-gold/50'}`}
                    >
                      {o.payment_status}
                    </span>
                  </td>
